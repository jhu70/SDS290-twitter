...
Z: The average of the tickets in the error box should be zero. This means that the average of a set of observed values should tend to fall near the underlying true value. According to the graph, the average of the tickets in the error box is zero and the dots are clustering around zero.
